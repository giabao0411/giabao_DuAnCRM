            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="<%=request.getContextPath() + "/jobs-add"%>" method="post">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12">Start Days</label>
                                    <div class="col-md-12">
                                        <input type="date" name="start_date" placeholder="dd/MM/yyyy"
                                            class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">End Days</label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        ...
                                        <a href="<%=request.getContextPath() + "/jobs-table"%>" class="btn btn-primary">Back</a>
                                    </div>
                                </div>
                            </form>
                        </div>
